...
\author{\textbf{Luis F. Rosario Freytes}\\University of Michigan}

% Keep the public preprint visually identical to the conference manuscript while
% removing review-only furniture.  This exposes the author without claiming
% conference publication status and disables the anonymous review ruler.
\iclrfinalcopy
\makeatletter
...
\appendix
\input{appendices/A_process_and_presentation_details}
\input{appendices/B_finite_distribution_geometry}
\input{appendices/C_exact_shadow_details}
\input{appendices/D_fixed_or_extensions}
\input{appendices/E_access_image_descent}
